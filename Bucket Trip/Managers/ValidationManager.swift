...
class ValidationManager: NSObject {
    ...
    func validateRegisterForm(userName:String, fullName:String,email:String,password:String,country:CountryModel?,phone:String) -> String {
        ...
        if fullName.isEmpty {
            ...
            msg = ValidationStr.COUNTRY_EMPTY_ERROR
            return msg
        }
    ...
    func validateEditProfileForm(fullName:String,country:CountryModel?,aboutme:String) -> String {
